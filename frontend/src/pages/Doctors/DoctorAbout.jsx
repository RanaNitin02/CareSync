        ...
        <div className="mt-12">
            ...
            <ul className="pt-4 md:p-5">
                ...
                {qualifications?.map((item, index) => <li key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
                    ...
                    <p className="leading-5 text-[14px] font-medium text-textColor "> {item.university}</p>
                </li>)}
            ...
            <ul className="grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5 ">
                {
                    ...
                    <p className="leading-5 text-[14px] font-medium text-textColor ">{item.hospital}</p>
                </li>)
                }
            </ul>
